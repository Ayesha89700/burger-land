...
const TeamCard = ({image, name, position}: Props) => {
  return (
    <div>
      <Image 
        src={image} 
        alt={name || 'Default alt text'} // Alt text for accessibility
        height={400}
        width={400} 
      ...
      <p className="text-center md:w-[70%] mx-auto text-gray-600 mt-[1rem]">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus natus id ex voluptatibus impedit, ab, ducimus minus quod deleniti blanditiis et in magnam.
      </p>
    </div>
  )
}
